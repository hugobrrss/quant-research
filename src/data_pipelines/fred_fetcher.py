...
def fetch_fred_series(series_ids: list[str],
    ...
    """
    Args:
        - series_ids: FRED series id inserted as list
...
def fetch_macro_universe(group_names: list[str], start_date: str = None, end_date: str = None) -> pd.DataFrame:
    """
    ...
    Args:
        ...
        - end_date: format 'YYYY-MM-DD'
    """
    project_root = Path(__file__).parent.parent.parent # this assumes src/execution
    ...
    return fetch_fred_series(series_ids, start_date, end_date)
